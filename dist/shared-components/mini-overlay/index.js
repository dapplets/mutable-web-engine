...
const MiniOverlay = ({ baseMutation, mutationApps, connectWallet, disconnectWallet, nearNetwork, children, trackingRefs = new Set(), }) => {
    ...
    return (react_1.default.createElement(SidePanelWrapper, { ref: rootRef, "$isApps": mutationApps.length > 0, "data-mweb-context-type": "mweb-overlay", "data-mweb-context-parsed": JSON.stringify({ id: 'mweb-overlay' }) },
        react_1.default.createElement(TopBlock, { "$open": isOpen || mutationApps.length > 0, "$noMutations": !mutationApps.length },
            react_1.default.createElement(MutationIconWrapper, { "$isButton": !!connectWallet && !!disconnectWallet && !!nearNetwork, title: baseMutation === null || baseMutation === void 0 ? void 0 : baseMutation.metadata.name, onClick: handleMutationIconClick, ref: openCloseWalletPopupRef }, (baseMutation === null || baseMutation === void 0 ? void 0 : baseMutation.metadata.image) ? (react_1.default.createElement(Image_1.Image, { image: baseMutation === null || baseMutation === void 0 ? void 0 : baseMutation.metadata.image })) : (react_1.default.createElement(MutationFallbackIcon, null)))),
        ...
        isProfileOpen && connectWallet && disconnectWallet && nearNetwork ? (react_1.default.createElement(Profile_1.default, { accountId: loggedInAccountId, closeProfile: () => setProfileOpen(false), connectWallet: connectWallet, disconnectWallet: disconnectWallet, nearNetwork: nearNetwork, trackingRefs: trackingRefs, openCloseWalletPopupRef: openCloseWalletPopupRef })) : null));
};
